...
type ToolsWithChildProps = {
  children: React.ReactNode
}


//initial vales to all tools
const InitialValues: ToolsType = {
  discordNode: {
    webhookURL: '',
    content: '',
    webhookName: '',
...
const ToolsContext = createContext(InitialValues)
const { Provider } = ToolsContext



//provider
export const ToolsProvider = ({ children }: ToolsWithChildProps) => 
{
