    ...
    <section className="flex w-full justify-center md:flex-row flex-col gap-6">
      {products &&
        products.map((product: any) => (
          <Card
            className="p-3 bg-[#e2f24b] text-neutral-900"
            key={product.id}
          >
            <CardHeader>
            ...
            <CardContent className="flex flex-col gap-5 ">
              <CardDescription className='text-neutral-900' >
                {product.nickname == 'Unlimited'
                  ...
                  : product.nickname == 'Free' &&
                    "Get a monthly wave of credits to automate your tasks with ease. Perfect for starters looking to dip their toes into Zency's automation capabilities."}
              </CardDescription>
              <div className="flex justify-between ">
                ...
                <p className="font-bold">
                  {product.nickname == 'Free'
                    ...
                    : product.nickname == 'Pro'
                    ? '99.99'
                    : product.nickname == 'Unlimited' && '199.99'}
                  /mo
                </p>
              </div>
              {product.nickname == tier ? (
                <Button
                  disabled
                //   variant="outline" 
                  className='bg-neutral-900 text-neutral-50 hover:text-neutral-900'
                >
                  Active
                </Button>
              ) : (
